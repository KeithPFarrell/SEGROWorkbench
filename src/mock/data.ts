...
export const meterDataCycles: MeterDataCycle[] = [
  ...
  { id: '4', market: 'FR', period: 'October 2025', date: '08/10/25', status: 'stale', qualityScore: 0 },
  { id: '5', market: 'PL', period: 'October 2025', date: '12/10/25', status: 'stale', qualityScore: 0 },
  { id: '6', market: 'NL', period: 'September 2025', date: '22/09/25', status: 'stale', qualityScore: 0 },
  { id: '7', market: 'ES', period: 'October 2025', date: '03/10/25', status: 'stale', qualityScore: 0 },
...
export const ul360Tasks: UL360Task[] = [
  {
    id: 'ul360-1',
    type: 'upload',
    title: 'UK Electricity Upload - December 2025',
    description: 'Upload meter data for UK electricity consumption',
    market: 'UK',
    status: 'pending',
  ...
  },
  {
    id: 'ul360-2',
    type: 'upload',
    title: 'CZ Gas Upload - November 2025',
    description: 'Upload meter data for Czech Republic gas consumption',
    market: 'CZ',
    status: 'attention',
    ...
    errorReportUploaded: false,
    meterCount: 180,
    errorCount: 12,
    fileUrl: '/api/download/cz-nov-2025-gas.xlsx',
  },
];
...
export const meterExceptionTasks: MeterExceptionTask[] = [
  ...
  },
  {
    ...
    updatedAt: '2026-01-16T09:45:00Z',
    missingMeterCount: 8,
    meterCount: 8,
    exceptionFileGenerated: false,
    registryImported: false,
  ...
  },
  {
    ...
    updatedAt: '2026-01-15T13:20:00Z',
    missingMeterCount: 14,
    meterCount: 14,
    exceptionFileGenerated: false,
    registryImported: false,
    reprocessingTriggered: false,
...
export const validationTasks: ValidationTask[] = [
  {
    ...
    description: 'Review and correct data quality issues for UK December cycle',
    market: 'UK',
    status: 'attention',
    createdAt: '2026-01-17T10:00:00Z',
    updatedAt: '2026-01-20T09:15:00Z',
    errorType: 'Missing Values',
    errorDetails: '12 meters have incomplete consumption data',
    meterCount: 12,
...
export const archiveFiles: ArchiveFile[] = [
  {
    id: 'file-1',
    filename: '260119 UK Stark Electricity Upload File - December 25.xlsx',
    cycle: 'December 2025',
    market: 'UK',
  ...
  {
    id: 'file-5',
    filename: 'DE Electricity Upload File - November 25.xlsx',
    cycle: 'November 2025',
    market: 'DE',

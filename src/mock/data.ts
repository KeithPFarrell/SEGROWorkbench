...
export const validationTasks: ValidationTask[] = [
  {
    ...
    errorDetails: '12 meters have data issues and have not been included in the UL 360 upload file. These meters can\'t be processed until the validation errors have been reviewed and corrected.',
    meterCount: 12,
